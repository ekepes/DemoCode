    ...
    for node in graph.childrenOf(start):
        if node not in path: #avoid cycles
            ...
            if newPath != None:
                ...
                #print 'Testing: ', newTotalDist, maxTotalDist, newOutDist, maxDistOutdoors, newTotalDist < maxTotalDist, newOutDist < maxDistOutdoors
...
def test():
    ...
    result2A = bruteForceSearch(map2, "1", "3", 100, 100)
    print 'Expected = [1, 2, 3]'
    print result2A
    print '---------------------'
    result2B = bruteForceSearch(map2, "1", "3", 18, 18)
    print 'Expected = [1, 4, 3]'
    print result2B
    print '---------------------'
    map3 = load_map('map3.txt')
    result3B = bruteForceSearch(map3, "1", "3", 18, 18)
    print 'Expected = [1, 2, 3]'
    print result3B
